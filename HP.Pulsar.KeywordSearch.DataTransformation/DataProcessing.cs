...
namespace HP.Pulsar.KeywordSearch.DataTransformation
{
    public class DataProcessing
    {
        ...
        public string ChangeDateFormat (string PropertyValue)
        {
            return PropertyValue.Split(" ")[0];
        }

        public string AddPropertyName(string propertyName, string propertyValue)
        {
